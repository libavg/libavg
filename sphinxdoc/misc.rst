...
.. automodule:: libavg.avg
    ...
    .. autoclass:: SVG(filename[, unescapeIllustratorIDs=False[, useLogicalBbox=False]])
        ...
        :param useLogicalBbox:

            By default the ink bounding box (stroked, filled) of an element is used for
            rendering and returned by :py:meth:`getElementPos` and :py:meth:`getElementSize`.
            If this parameter is :py:const:`True`, the logical bounding box (unstroked, unfilled)
            is used instead.
