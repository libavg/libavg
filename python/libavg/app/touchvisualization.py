...
class BaseTouchVisualization(avg.DivNode):
    def __init__(self, event, parent=None, **kwargs):
        super(BaseTouchVisualization, self).__init__(**kwargs)
...
class DebugTouchVisualization(BaseTouchVisualization):
    def __init__(self, event, **kwargs):
        super(DebugTouchVisualization, self).__init__(event, **kwargs)
    ...
    def _onMotion(self, event):
        super(DebugTouchVisualization, self)._onMotion(event)
...
class TouchVisualization(BaseTouchVisualization):
    ...
    def __init__(self, event, **kwargs):
        super(TouchVisualization, self).__init__(event, **kwargs)
    ...
    def _onMotion(self, event):
        super(TouchVisualization, self)._onMotion(event)
        self.__setRadius(self._radius)
