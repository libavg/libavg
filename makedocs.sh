#/bin/bash
epydoc --html -v -o reference --name libavg --url ../index.html --docformat epytext --no-frames --graph classtree --css epydoc_libavg.css --no-private --graph-font="lucida console" libavg
