...
{
    init(size, pfSrc, IntRect(IntPoint(0,0), size), pfDest, bStandalone, GL_CLAMP_TO_EDGE,
            numTextures);
}
...
{
    init(srcSize, pfSrc, destRect, pfDest, bStandalone, GL_CLAMP_TO_BORDER, numTextures);
}
