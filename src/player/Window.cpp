...
vector<long> Window::s_KeyCodeTranslationTable(SDLK_LAST, key::KEY_UNKNOWN);
        ...
        long button)
{
    ...
    x = int((x*m_Viewport.width())/m_Size.x);
    y = int((y*m_Viewport.height())/m_Size.y);
...
EventPtr Window::createMouseButtonEvent(Event::Type type, 
...
/*
EventPtr Window::createAxisEvent(const SDL_Event & sdlEvent)
{
...
EventPtr Window::createButtonEvent
...
void Window::initTranslationTable()
{
