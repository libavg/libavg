    ...
    def testTapRecognizer(self):
        ...
        self.start(False,
                (# Down-up: recognized as tap.
                 ...
                 self.__genMouseEventFrames(avg.Event.CURSOR_DOWN, 30, 30,
                        [EVENT_POSSIBLE]),
                 self.__genMouseEventFrames(avg.Event.CURSOR_MOTION, 80, 80, 
                        [EVENT_FAILED]),
                 self.__genMouseEventFrames(avg.Event.CURSOR_UP, 30, 30, []),
    ...
    def testHoldRecognizer(self):
        ...
        self.start(False,
                (# Standard down-hold-up sequence.
                 ...
                 self.__genMouseEventFrames(avg.Event.CURSOR_DOWN, 1, 1, 
                        [EVENT_POSSIBLE]),
                 self.__genMouseEventFrames(avg.Event.CURSOR_MOTION, 150, 50, 
                        [EVENT_FAILED]),
                 self.__genMouseEventFrames(avg.Event.CURSOR_UP, 30, 30, []),
    ...
    def testDoubletapRecognizer(self):
        ...
        self.start(False,
                (# Down, up, down, up: click
                 ...
                 self.__genMouseEventFrames(avg.Event.CURSOR_UP, 0, 30, []),
                 self.__genMouseEventFrames(avg.Event.CURSOR_MOTION, 80, 30, []),
                 self.__genMouseEventFrames(avg.Event.CURSOR_DOWN, 80, 30, 
                        [EVENT_FAILED]),
                 self.__genMouseEventFrames(avg.Event.CURSOR_UP, 0, 30, []),
    ...
    def testDragRecognizer(self):
        ...
        for self.friction in (-1, 100):
            ...
            self.start(False,
                    (self.__genMouseEventFrames(avg.Event.CURSOR_DOWN, 30, 30,
                            [EVENT_DETECTED]),
                     self.__genMouseEventFrames(avg.Event.CURSOR_MOTION, 70, 70, 
                            [EVENT_MOVED]),
        ...
        for self.friction in (-1, 100):
            ...
            self.start(False,
                    (self.__genMouseEventFrames(avg.Event.CURSOR_DOWN, 30, 30, 
                     ...
                     self.__genMouseEventFrames(avg.Event.CURSOR_DOWN, 30, 30, 
                            [EVENT_POSSIBLE]),
                     self.__genMouseEventFrames(avg.Event.CURSOR_MOTION, 70, 30, 
                            [EVENT_FAILED]),
