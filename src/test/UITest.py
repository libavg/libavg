    ...
    def testKeyboard(self):
        ...
        self.start(False,
                (lambda: self.compareImage("testUIKeyboard"),
                 ...
                 lambda: assertState((ui.Keyboard.DOWN,ui.Keyboard.CHAR), "a",
                        "testUIKeyboard"),
                 self.__messageTester.reset,
                 # test command key
                 ...
                 lambda: assertState((ui.Keyboard.DOWN,), "SHIFT", "testUIKeyboard"),
                 self.__messageTester.reset,
                 # test multiple keys
                 ...
                 lambda: assertState((ui.Keyboard.CHAR,), "a", "testUIKeyboard1S"),
                 lambda: self._sendTouchEvent(3, avg.Event.CURSOR_UP, 60, 30),
                 lambda: assertState((ui.Keyboard.CHAR,), "1", "testUIKeyboardS"),
                 self.__messageTester.reset,
                 lambda: self._sendTouchEvent(1, avg.Event.CURSOR_UP, 100, 30),
                 lambda: assertState((), "1", "testUIKeyboard"),
                ))
        ...
        self.start(False,
                ...
                (lambda: self.compareImage("testUIKeyboardFB"),
                 ...
                 lambda: assertState((ui.Keyboard.CHAR,), "A", "testUIKeyboardNoFB1S"),
                 lambda: self._sendTouchEvent(3, avg.Event.CURSOR_UP, 60, 80),
                 lambda: assertState((ui.Keyboard.CHAR,), "1", "testUIKeyboardFBS"),
                 ...
                 lambda: assertState((ui.Keyboard.DOWN,), "1", "testUIKeyboardFB"),
                 ...
                 lambda: assertState((ui.Keyboard.DOWN,ui.Keyboard.CHAR), "1",
                        "testUIKeyboardFB"),
                ))           
