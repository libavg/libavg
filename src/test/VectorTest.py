...
#                 lambda: self.compareImage("testTexturedRect8", False),
    ...
    def testPolygon(self):
        ...
        def createLeftOpenPolygon():
            polygon.pos = ( (15,0), (35,0), (55,10), (65,30), (55,50), (35,60), (15,60), (5,50), (15,40), (35,40), (35,30), (35,20), (15,20), (5,10) )
            polygon.strokewidth = 1

        def createUpOpenPolygon():
            polygon.pos = ( (15,0), (25,10), (25,30), (35,30), (45,30), (45,10), (55,0), (65,10), (65,30), (55,50), (35,60), (15,50), (5,30), (5,10) )

        def createBottomOpenPolygon():
            polygon.pos = ( (35,0), (55,10), (65,30), (65,50), (55,60), (45,50), (45,30), (35,30), (25,30), (25,50), (15,60), (5,50), (5,30), (15,10) )

        def createOneHole():
            polygon.holes = ( [(35,10), (40,15), (35,20), (30,15)], )

        def createMoreHoles():
            newHoles = ( polygon.holes[0], [(20,35), (20,45), (10,40)], [(50,35), (50,45), (60,40)], )
