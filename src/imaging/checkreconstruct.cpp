...
void filterImage(const string& fName)
{
    ...
    FreqFilter f(pSrcBmp->getSize());
    float frequencies[4] = {5, 10, 12, 15}; 
    float amplitudes[4] = {1, 10, 10, 10}; 
    f.setFrequencies(vectorFromCArray(4, frequencies), vectorFromCArray(4, amplitudes));
