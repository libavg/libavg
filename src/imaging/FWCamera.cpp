...
FWCamera::~FWCamera()
{
    ...
    dc1394_free(m_pDC1394);
#endif
    AVG_TRACE(logging::category::CONFIG, logging::level::INFO, "Firewire camera closed.");
}
...
void FWCamera::startCapture()
{
    ...
    AVG_TRACE(logging::category::CONFIG, logging::level::INFO, "Firewire camera opened.");
