...
float Triangulate::Area(const DPointVector &contour)
{
...
bool Triangulate::Snip(const DPointVector &contour,int u,int v,int w,int n,int *V)
{
  int p;
...
bool Triangulate::Process(const DPointVector &contour, TriangleVector &result)
{
